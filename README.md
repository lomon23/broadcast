...
# Про що? 
        брод каст, це значення чату в якому немає поділу на приватні чати, це один суцільний чат, в якому всі можуть переписуватись, це нас вертає в гіковські часи 2000х, де це була база для форумів
